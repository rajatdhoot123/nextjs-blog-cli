...
const Header = () => {
  ...
  return (
    <>
      ...
      <header
        className={`header px-5 ${sticky && "header-sticky"} ${
      ...
      >
        <nav className="navbar container-xl">
          <div className="order-0">
            <img className="h-12 w-12" src="/vercel.svg" />
          </div>
          ...
          >
            ...
            {config.nav_top_right_button.enable && (
              <li className="nav-item lg:hidden">
                <Link
                  className="btn btn-primary hidden lg:flex"
                  href={config.nav_top_right_button.link}
                >
                  {config.nav_top_right_button.label}
                </Link>
              </li>
            )}
          </ul>
